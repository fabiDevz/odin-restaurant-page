function cargarMenu()
{
    ...
    const productosMenu = [
        ...
        { nombre: 'Café de Filtro Etiopía Yirgacheffe', descripcion: 'Una experiencia sensorial única, con notas florales y afrutadas que provienen de los exuberantes campos de café de Etiopía.', url: './img/menu_producto_4.jpg' },
